...
public class MergedWurfl91Mobile2 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		        ...
		        try {
					System.setOut(outputFile("map91mobileswurfl20.txt"));
			...
			//	    System.out.println();
			 ...
			 //   for(int j =0; i <intersectionList.size(); j++){
			    
			    //     if(intersectionList.get(j).contains("_")==true){
                ...
                // Hashmap
			      ...
			      for (Entry<String, Integer> entry : modelMap.entrySet()) { // Iterate
					// through
                      ...
                      System.out.println(keyword+":"+maxValueInMap+":"+modelMap.size());
			    	  break;
			    	  }
